 ...
 */
@WebServlet(name = "ChartGenerationServlet", urlPatterns = {"/charts/*"})
public class ChartGenerationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.write(questionService.getStatisticsForIssuedQuestion(questionCode));
        } finally {
            out.close();
        }
    }
